    ...
    if (loot)
    {
        ...
        if (shareMoney && player->GetGroup())      //item, pickpocket and players can be looted only single player
        {
            ...
            for (std::vector<Player*>::const_iterator i = playersNear.begin(); i != playersNear.end(); ++i)
            {
                ...
                (*i)->UpdateAchievementCriteria(ACHIEVEMENT_CRITERIA_TYPE_LOOT_MONEY, goldPerPlayer + goldMod);
        ...
        else
        {
            ...
            player->UpdateAchievementCriteria(ACHIEVEMENT_CRITERIA_TYPE_LOOT_MONEY, loot->gold + goldMod);
