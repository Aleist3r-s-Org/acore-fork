...
enum TalentTree // talent tabs
{
    ...
    TALENT_TREE_MAGE_LIGHTNING = 439,
    TALENT_TREE_WARLOCK_AFFLICTION = 302,
    TALENT_TREE_WARLOCK_DEMONOLOGY = 303,
    TALENT_TREE_WARLOCK_DESTRUCTION = 301,
    TALENT_TREE_MONK_BREWMASTER = 441,
    TALENT_TREE_MONK_MISTWEAVER = 442,
    TALENT_TREE_MONK_WINDWALKER = 443,
    TALENT_TREE_DRUID_BALANCE = 283,
    TALENT_TREE_DRUID_FERAL_COMBAT = 281,
    TALENT_TREE_DRUID_RESTORATION = 282,
    TALENT_TREE_DEMON_HUNTER_ANGUISH = 446,
    TALENT_TREE_DEMON_HUNTER_HAVOC = 447,
    TALENT_TREE_DEMON_HUNTER_VENGEANCE = 448
};
