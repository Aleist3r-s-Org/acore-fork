...
std::string Transmogrification::GetItemLink(uint32 entry, WorldSession* session)
{
    ...
    const ItemTemplate* temp = sObjectMgr->GetItemTemplate(entry);
    std::ostringstream oss;
    oss << "|c" << std::hex << MiscColors[0] << std::dec <<
...
bool Transmogrification::IsMeleeWeapon(ItemTemplate const* itemTemplate)
{
    ...
    return Class == ITEM_CLASS_WEAPON && (
        ...
        SubClass == ITEM_SUBCLASS_WEAPON_WARGLAIVE ||
...
static std::map<SkillType, uint32> SkillToClassMask =
{
    ...
    { SKILL_LEATHER, classesToClassMask({CLASS_PALADIN, CLASS_WARRIOR, CLASS_DEATH_KNIGHT, CLASS_HUNTER, CLASS_SHAMAN, CLASS_DRUID, CLASS_ROGUE, CLASS_MONK, CLASS_DEMON_HUNTER })},
    ...
    { SKILL_AXES, classesToClassMask({CLASS_WARRIOR, CLASS_SHAMAN, CLASS_PALADIN, CLASS_HUNTER, CLASS_DEATH_KNIGHT, CLASS_ROGUE, CLASS_MONK, CLASS_DEMON_HUNTER})},

    { SKILL_2H_SWORDS, classesToClassMask({CLASS_WARRIOR, CLASS_PALADIN, CLASS_HUNTER, CLASS_DEATH_KNIGHT})},
    { SKILL_SWORDS, classesToClassMask({CLASS_WARRIOR, CLASS_PALADIN, CLASS_HUNTER, CLASS_DEATH_KNIGHT, CLASS_WARLOCK, CLASS_ROGUE, CLASS_MAGE, CLASS_MONK, CLASS_DEMON_HUNTER})},

    { SKILL_WARGLAIVES, classesToClassMask({CLASS_WARRIOR, CLASS_ROGUE, CLASS_DEMON_HUNTER})},

    { SKILL_2H_MACES, classesToClassMask({CLASS_WARRIOR, CLASS_SHAMAN, CLASS_PALADIN, CLASS_DRUID, CLASS_DEATH_KNIGHT})},
    { SKILL_MACES, classesToClassMask({CLASS_WARRIOR, CLASS_SHAMAN, CLASS_PALADIN, CLASS_DRUID, CLASS_DEATH_KNIGHT, CLASS_ROGUE, CLASS_PRIEST, CLASS_MONK})},
    ...
    { SKILL_STAVES, classesToClassMask({CLASS_WARRIOR, CLASS_WARLOCK, CLASS_SHAMAN, CLASS_PRIEST, CLASS_MAGE, CLASS_HUNTER, CLASS_DRUID, CLASS_MONK})},
    { SKILL_POLEARMS, classesToClassMask({CLASS_WARRIOR, CLASS_PALADIN, CLASS_HUNTER, CLASS_DRUID, CLASS_DEATH_KNIGHT, CLASS_SHAMAN, CLASS_MONK, CLASS_DEMON_HUNTER})},
    { SKILL_FIST_WEAPONS, classesToClassMask({CLASS_WARRIOR, CLASS_SHAMAN, CLASS_ROGUE, CLASS_HUNTER, CLASS_DRUID, CLASS_MONK, CLASS_DEMON_HUNTER})},
...
uint32 Transmogrification::AddItemVisualToCollection(Player* player, const ItemTemplate* itemtemplate)
{
    ...
    if (!itemtemplate || !CanAddToCollection(player, itemtemplate) || slot == NULL_SLOT || HasVisual(player, slot, itemtemplate->ItemId))
        return 0;   
