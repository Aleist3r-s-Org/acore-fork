...
void Player::UpdateAttackPowerAndDamage(bool ranged)
{
    ...
    else
    {
        ...
        else if (IsClass(CLASS_HUNTER, CLASS_CONTEXT_STATS) || IsClass(CLASS_SHAMAN, CLASS_CONTEXT_STATS) || IsClass(CLASS_ROGUE, CLASS_CONTEXT_STATS) || IsClass(CLASS_DEMON_HUNTER, CLASS_CONTEXT_STATS) || IsClass(CLASS_MONK, CLASS_CONTEXT_STATS))
        {
